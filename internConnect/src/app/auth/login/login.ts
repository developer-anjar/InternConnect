...
export class Login implements OnInit {
 ...
 userType: string = 'student';
  ...
  sendForgotEmail() {
    ...
    this.http.post('https://internconnect-5n7j.onrender.com/api/student/forgot-password', { email: this.forgotEmail }).subscribe({
 ...
 onLogin() {
  if (this.loginForm.valid) {
    ...
    this.http.post('https://internconnect-5n7j.onrender.com/api/student/login', this.loginForm.value)
      .subscribe({
        next: (res: any) => {
